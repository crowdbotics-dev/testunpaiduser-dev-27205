...
## Project Structure
    ...
    ├── testunpaiduser_dev_27205  # Django project configurations
...
1. Clone this repo and `cd testunpaiduser_dev_27205`
...
2. Clone this repo and `cd testunpaiduser_dev_27205`
